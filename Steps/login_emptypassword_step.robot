...
Library                   DataDriver    ../Resources/login_empty_password.csv    sheet_name=Sheet1
Test Setup                Open Browser    ${WebURL}   ${BROWSER}
Test Teardown             Close Browser
Test Template             I want to login with empty password
...
*** Test Cases ***
Login with empty password       ${username}     ${password}
